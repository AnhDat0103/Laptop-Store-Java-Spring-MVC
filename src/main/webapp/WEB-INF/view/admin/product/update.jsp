                        ...
                        <div class="container mt-5">
                          <div class="row">
                              <div class="col-md-6 col-12 mx-auto">
                                  <h2>Update product id = ${productUpdate.id}</h2>  
                          <hr>
                          <form:form action="/admin/product/update" method="POST" modelAttribute="productUpdate" class="row"
                          enctype="multipart/form-data">
                            <div class="mb-3 col-12 col-md-6" style="display: none;">
                                <form:label for="id" class="form-label" path="id">ID:</form:label>
                              ...
                              <div class="col-12 mb-3 ">
                                <img style="max-height: 250px" src="/images/product/${productUpdate.image}" alt="avatar preview"
                                    id="avatarPreview" />
                              </div>
